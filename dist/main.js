!function (t) {
  ...
  (function (t, n) {
    ...
    var Ct = function (t) {
      (this.value = t, this.dep = new ct(), this.vmCount = 0, U(t, "__ob__", this), Array.isArray(t)) ? ((H ? $t : At)(t, gt, _t), this.observeArray(t)) : this.walk(t);
    };
    ...
    function Mt(t, e, n) {
      "function" == typeof e && (e = e.options), function (t, e) {
        ...
        if (n) {
          ...
          if (Array.isArray(n)) for (r = n.length; r--;) "string" == typeof (o = n[r]) && (i[C(o)] = {
            type: null
          });else if (l(n)) for (var a in n) o = n[a], i[C(a)] = l(o) ? o : {
            type: o
          };
          t.props = i;
        }
      ...
      var r = e.extends;
      if (r && (t = Mt(t, r, n)), e.mixins) for (var o = 0, i = e.mixins.length; o < i; o++) t = Mt(t, e.mixins[o], n);
      var a,
          s = {};
    ...
    function Se() {
      ...
      for (ke = !0, $e.sort(function (t, e) {
        return t.id - e.id;
      }), Te = 0; Te < $e.length; Te++) e = (t = $e[Te]).id, xe[e] = null, t.run();

      var n = Ae.slice(),
          r = $e.slice();
      Te = $e.length = Ae.length = 0, xe = {}, Oe = ke = !1, function (t) {
    ...
    function Le(t) {
      ...
      e.props && function (t, e) {
        ...
        for (var o in e) {
          ...
          0, r || (n[o] = new Ie(t, a || E, E, Me)), o in t || Ne(t, o, i);
        }
    ...
    function ze(t, e, n, r, o) {
      ...
      return o && r && !R.keyCodes[e] ? He(o, r) : i ? He(i, t) : r ? x(r) !== e : void 0;
    }
    ...
    function Ze(t) {
      t._o = Ke, t._n = v, t._s = d, t._l = Ue, t._t = Ve, t._q = P, t._i = L, t._m = qe, t._f = Be, t._k = ze, t._b = We, t._v = ht, t._e = vt, t._u = ge, t._g = Je;
    }
    ...
    function Qe(t, e, n, o, i) {
      ...
      var u = a(c._compiled),
          l = !u;
      this.data = t, this.props = e, this.children = n, this.parent = o, this.listeners = t.on || r, this.injections = Re(c.inject, o), this.slots = function () {
        return me(n, o);
    ...
    var en = {
      ...
      insert: function (t) {
        ...
        r._isMounted || (r._isMounted = !0, Ce(r, "mounted")), t.data.keepAlive && (n._isMounted ? ((e = r)._inactive = !1, Ae.push(e)) : we(r, !0));
      },
      destroy: function (t) {
        ...
        if (c(t) && (t = l.extend(t)), "function" == typeof t) {
          ...
          if (a(t.options.functional)) return function (t, e, n, o, a) {
            var s = t.options,
                c = {},
                u = s.props;
            if (i(u)) for (var l in u) c[l] = Dt(l, u, e || r);else i(n.attrs) && tn(c, n.attrs), i(n.props) && tn(c, n.props);
    ...
    function sn(t, e, n, r, u, l) {
      return (Array.isArray(n) || s(n)) && (u = r, r = n, n = void 0), a(l) && (u = an), function (t, e, n, r, s) {
        ...
        if ("string" == typeof e) {
          var f;
          l = t.$vnode && t.$vnode.ns || R.getTagNamespace(e), u = R.isReservedTag(e) ? new pt(R.parsePlatformTagName(e), n, r, void 0, void 0, t) : i(f = Nt(t.$options, "components", e)) ? rn(f, n, t, r, e) : new pt(e, n, r, void 0, void 0, t);
        } else u = rn(e, n, t, r);
    ...
    !function (t) {
      t.prototype._init = function (t) {
        ...
        }(e, t) : e.$options = Mt(un(e.constructor), t || {}, e), e._renderProxy = e, e._self = e, function (t) {
          var e = t.$options,
              n = e.parent;
    ...
    function Kn(t, e) {
      ...
      for (n = 0; n < t.length; n++) (r = t[n]).modifiers || (r.modifiers = qn), o[Xn(r)] = r, r.def = Nt(e.$options, "directives", r.name);
    ...
    function Zn(t, e) {
      ...
      if (!(i(n) && !1 === n.Ctor.options.inheritAttrs || o(t.data.attrs) && o(e.data.attrs))) {
        ...
        for (r in (X || J) && u.value !== c.value && Qn(s, "value", u.value), c) o(u[r]) && (An(r) ? s.removeAttributeNS($n, xn(r)) : wn(r) || s.removeAttribute(r));
      }
    }

    function Qn(t, e, n) {
      t.tagName.indexOf("-") > -1 ? Yn(t, e, n) : Cn(e) ? On(n) ? t.removeAttribute(e) : (n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : wn(e) ? t.setAttribute(e, On(n) || "false" === n ? "false" : "true") : An(e) ? On(n) ? t.removeAttributeNS($n, xn(e)) : t.setAttributeNS($n, e, n) : Yn(t, e, n);
    }
    ...
    var kr = b(function (t) {
      return {
        ...
        Pr = "animation",
        Lr = "animationend";
    Tr && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Ir = "WebkitTransition", jr = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (Pr = "WebkitAnimation", Lr = "webkitAnimationEnd"));
    var Mr = z ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : function (t) {
      return t();
    };
    ...
    function Vr(t, e) {
      ...
      return e === Sr ? a > 0 && (n = Sr, l = a, f = i.length) : e === Er ? u > 0 && (n = Er, l = u, f = c.length) : f = (n = (l = Math.max(a, u)) > 0 ? a > u ? Sr : Er : null) ? n === Sr ? i.length : c.length : 0, {
        ...
        timeout: l,
        propCount: f,
        hasTransform: n === Sr && Ur.test(r[Ir + "Property"])
      };
    }
    ...
    function zr(t, e) {
      ...
      if (!o(r) && !i(n._enterCb) && 1 === n.nodeType) {
        for (var a = r.css, s = r.type, u = r.enterClass, l = r.enterToClass, f = r.enterActiveClass, p = r.appearClass, d = r.appearToClass, h = r.appearActiveClass, m = r.beforeEnter, y = r.enter, g = r.afterEnter, _ = r.enterCancelled, b = r.beforeAppear, w = r.appear, C = r.afterAppear, $ = r.appearCancelled, A = r.duration, x = _e, O = _e.$vnode; O && O.parent;) x = (O = O.parent).context;
        ...
        if (!k || w || "" === w) {
          ...
          var D = !1 !== a && !G,
            ...
            D && (Fr(n, E), Fr(n, S)), R.cancelled ? (D && Fr(n, T), L && L(n)) : P && P(n), n._enterCb = null;
          });
          t.data.show || ae(t, "insert", function () {
            var e = n.parentNode,
                r = e && e._pending && e._pending[t.key];
            r && r.tag === t.tag && r.elm._leaveCb && r.elm._leaveCb(), j && j(n, R);
          }), I && I(n), D && (Dr(n, T), Dr(n, S), Nr(function () {
            Fr(n, T), R.cancelled || (Dr(n, E), F || (qr(N) ? setTimeout(R, N) : Rr(n, s, R)));
          })), t.data.show && (e && e(), j && j(n, R)), D || F || R();
        }
      }
    }
    ...
    function Wr(t, e) {
      ...
      if (!i(n._leaveCb)) {
        ...
        var C = n._leaveCb = M(function () {
          n.parentNode && n.parentNode._pending && (n.parentNode._pending[t.key] = null), _ && (Fr(n, l), Fr(n, f)), C.cancelled ? (_ && Fr(n, u), m && m(n)) : (e(), h && h(n)), n._leaveCb = null;
        });
        y ? y($) : $();
      }

      function $() {
        C.cancelled || (t.data.show || ((n.parentNode._pending || (n.parentNode._pending = {}))[t.key] = t), p && p(n), _ && (Dr(n, u), Dr(n, f), Nr(function () {
          Fr(n, u), C.cancelled || (Dr(n, l), b || (qr(w) ? setTimeout(C, w) : Rr(n, s, C)));
        })), d && d(n, C), _ || b || C());
      }
    }
    ...
    var Gr = function (t) {
      ...
      for (e = 0; e < Vn.length; ++e) for (r[Vn[e]] = [], n = 0; n < c.length; ++n) i(c[n][Vn[e]]) && r[Vn[e]].push(c[n][Vn[e]]);
        ...
        if (t !== e) {
          ...
          if (a(t.isAsyncPlaceholder)) i(e.asyncFactory.resolved) ? k(t.elm, e, n) : e.isAsyncPlaceholder = !0;else if (a(e.isStatic) && a(t.isStatic) && e.key === t.key && (a(e.isCloned) || a(e.isOnce))) e.componentInstance = t.componentInstance;else {
            ...
            o(e.text) ? i(d) && i(v) ? d !== v && function (t, e, n, r, a) {
              for (var s, c, l, p = 0, d = 0, v = e.length - 1, h = e[0], m = e[v], y = n.length - 1, g = n[0], b = n[y], C = !a; p <= v && d <= y;) o(h) ? h = e[++p] : o(m) ? m = e[--v] : Bn(h, g) ? (A(h, g, r), h = e[++p], g = n[++d]) : Bn(m, b) ? (A(m, b, r), m = e[--v], b = n[--y]) : Bn(h, b) ? (A(h, b, r), C && u.insertBefore(t, h.elm, u.nextSibling(m.elm)), h = e[++p], b = n[--y]) : Bn(m, g) ? (A(m, g, r), C && u.insertBefore(t, m.elm, h.elm), m = e[--v], g = n[++d]) : (o(s) && (s = Hn(e, p, v)), o(c = i(g.key) ? s[g.key] : $(g, e, p, v)) ? f(g, r, t, h.elm, !1, n, d) : Bn(l = e[c], g) ? (A(l, g, r), e[c] = void 0, C && u.insertBefore(t, l.elm, h.elm)) : f(g, r, t, h.elm, !1, n, d), g = n[++d]);
      ...
      return function (t, e, n, s, c, l) {
        if (!o(e)) {
          var p,
              d = !1,
              v = [];
          if (o(t)) d = !0, f(e, v, c, l);else {
            var h = i(t.nodeType);
            if (!h && Bn(t, e)) A(t, e, v, s);else {
              if (h) {
                if (1 === t.nodeType && t.hasAttribute(N) && (t.removeAttribute(N), n = !0), a(n) && k(t, e, v)) return x(e, v, !0), t;
                p = t, t = new pt(u.tagName(p).toLowerCase(), {}, [], void 0, p);
              }

              var y = t.elm,
                  g = u.parentNode(y);
              if (f(e, v, y._leaveCb ? null : g, u.nextSibling(y)), i(e.parent)) for (var _ = e.parent, C = m(e); _;) {
                for (var $ = 0; $ < r.destroy.length; ++$) r.destroy[$](_);

                if (_.elm = e.elm, C) {
                  for (var O = 0; O < r.create.length; ++O) r.create[O](Un, _);
    ...
    var Jr = {
      inserted: function (t, e, n, r) {
        ...
        }) : Zr(t, e, n.context), t._vOptions = [].map.call(t.options, to)) : ("textarea" === n.tag || Nn(t.type)) && (t._vModifiers = e.modifiers, e.modifiers.lazy || (t.addEventListener("compositionstart", eo), t.addEventListener("compositionend", no), t.addEventListener("change", no), G && (t.vmodel = !0)));
      },
    ...
    function Qr(t, e, n) {
      ...
      if (!o || Array.isArray(r)) {
        for (var i, a, s = 0, c = t.options.length; s < c; s++) if (a = t.options[s], o) i = L(r, to(a)) > -1, a.selected !== i && (a.selected = i);else if (P(to(a), r)) return void (t.selectedIndex !== s && (t.selectedIndex = s));
          ...
          t.length && this.hasMove(t[0].elm, e) && (t.forEach(po), t.forEach(vo), t.forEach(ho), this._reflow = document.body.offsetHeight, t.forEach(function (t) {
            if (t.data.moved) {
              ...
              Dr(n, e), r.transform = r.WebkitTransform = r.transitionDuration = "", n.addEventListener(jr, n._moveCb = function t(r) {
                r && !/transform$/.test(r.propertyName) || (n.removeEventListener(jr, t), n._moveCb = null, Fr(n, e));
              });
            }
          }));
        },
    ...
    fn.config.mustUseProp = function (t, e, n) {
      ...
      return function (t, e, n) {
        var r;
        return t.$el = e, t.$options.render || (t.$options.render = vt), Ce(t, "beforeMount"), r = function () {
          t._update(t._render(), n);
        }, new Ie(t, r, E, null, !0), n = !1, null == t.$vnode && (t._isMounted = !0, Ce(t, "mounted")), t;
  ...
  var o = function (t, e, n, r, o, i, a, s) {
    ...
    var t = this.$createElement,
        e = this._self._c || t;
    return e("div", [e("h1", [this._v("Hello Vue World!")])]);
  }], !1, null, null, null);
